...
//
//if(number<10)
//	name = presur+"0000"+num2str(number)
...
//HDF5LoadDataset("Data:Axes1:Offset","MapInfo",datapath, name+"_angleoffset")
//wave angle_offset = $(name+"_angleoffset")
//HDF5LoadDataset("Data:Axes1:Delta","MapInfo",datapath, name+"_angledelta")
...
//	fermilevel = fixfermilevel_SSRL(cut2D,energylist[i]-4.365, 0.4)//0.4 can be changed
