...
//20180218 Cochran - Adapted from LoadStuff_pxt.ipf for ESM NSLSii beamline.

Function LoadStuffPxtESM(BaseName,NewNameBase,FirstFileNum,LastFileNum)
...
For(i = FirstFileNum;i<=LastFileNum;i+=1)
	...
	If(i<10)
		...
		tempname = "00" + num2str(i)
	Else
		If(i<100)
			dataname = baseName + "00" + num2str(i) + ".pxt"
			tempname = "0" + num2str(i)
		Else
			If(i<1000)
